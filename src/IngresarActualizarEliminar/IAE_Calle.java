 ...
 * @author USUARIO
 */
public class IAE_Calle extends javax.swing.JFrame {

    /**
     * Creates new form I_Calle
     */
    public IAE_Calle() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(24, 10, 170, 110));
        ...
        jPanel2.add(jCalle, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 50, 50, 50));
        ...
        jPanel1.setBackground(new java.awt.Color(44, 109, 212));
        ...
        jPanel1.add(bSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 10, 20, 20));
        ...
        jPanel1.add(bMinimizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 10, 20, 20));
        ...
        jPanel1.add(bRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 20, 20));
        ...
        jPanel1.add(lBarra, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 40));
 ...
 try{
                    ...
                    con=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=patentes;user=sa;password=sasa;");
                    Statement stmt= con.createStatement();
                    ResultSet rs=stmt.executeQuery("exec i_calle '"+clave_c+"','"+nom_c+"'");
 ...
 try{      
            String clave_c;
             clave_c = jTextField1.getText();
                  ...
                  Connection con;
                    con=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=PATENTES;user=sa;password=sasa;");
                    Statement stmt= con.createStatement();
                 ResultSet rs=stmt.executeQuery("select *from CALLE where clave_cAL='"+clave_c+"'");
                if (rs.next()) {
  ...
  try{
                    ...
                    con=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=patentes;user=sa;password=sasa;");
                    Statement stmt= con.createStatement();
                    ResultSet rs=stmt.executeQuery("exec act3 '"+clave_c+"','"+nom_c+"'");
 ...
 try{      
            String clave_t;
             clave_t = jTextField1.getText();
                  ...
                  Connection con;
                    con=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=patentes;user=sa;password=sasa;");
                    Statement stmt= con.createStatement();
                 ResultSet rs=stmt.executeQuery("exec bor3 '"+clave_t+"'");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IAE_Calle.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
