 ...
 * @author USUARIO
 */
public class IAE_Telefono_Inventor extends javax.swing.JFrame {

    /**
     * Creates new form I_Telefono_Inventor
     */
    public IAE_Telefono_Inventor() {
        initComponents();
    }
    int x,y;
    /**
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave del inventor", "Clave del Tipo Num.", "Numero Telefonico"
            }
        ));
        jTable1.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_NEXT_COLUMN);
        jScrollPane1.setViewportView(jTable1);

        jPanel3.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 890, 190));

        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 250, 950, 250));
        ...
        lBarra.setText("Teléfono de Inventor");
        ...
        jPanel2.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 150, 120, 30));

        jLabel3.setFont(new java.awt.Font("Nirmala UI", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(240, 240, 240));
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel3.setText("Numero telefónico:");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 150, 170, 30));

        jLabel2.setFont(new java.awt.Font("Nirmala UI", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(240, 240, 240));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Clave del inventor:");
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 40, 190, 30));
        jPanel2.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 40, 70, 30));
        jPanel2.add(jTextField3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 100, 70, 30));

        jLabel4.setFont(new java.awt.Font("Nirmala UI", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(240, 240, 240));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Clave: Tipo de Número:");
        jPanel2.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 100, 200, 30));
        ...
        jTel.setText("Consultar Telefono");
        jTel.setToolTipText("");
        ...
        jPanel2.add(jTel, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 90, 50, 50));
        ...
        jPanel2.add(jIngresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 60, 50, 50));
        ...
        jPanel2.add(jInventor, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 30, 50, 50));

        jEmpresa3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Iconos/contelinv.png"))); // NOI18N
        ...
        jPanel2.add(jEmpresa3, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 150, 50, 50));
        ...
        jPanel2.add(jActualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 60, 50, 50));
        ...
        jPanel2.add(jActualizarClave, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 60, 50, 50));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 950, 210));
 ...
 {                                  
    ...
    private void jIngresarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jIngresarMouseClicked
        ...
        try{
                    ...
                    ResultSet rs=stmt.executeQuery("exec i_t_inventor "+clave_a+","+clave_T+",'"+num+"' ");
                    
                }
                catch(SQLException e)  {
                //    JOptionPane.showMessageDialog(null, e);
    }    
        jTextField1.setText("");jTextField2.setText("");jTextField3.setText(""); jTextField1.setEnabled(true);       // TODO add your handling code here:
    ...
    private void jEmpresa3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jEmpresa3MouseClicked
        ...
        try
        {
            ...
            con= DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=PATENTES; user=sa; password=sasa;");
            Statement stmt=con.createStatement();
            ResultSet rs=stmt.executeQuery("exec TELIN");
            tabla.addColumn("INVENTOR");
    ...
    private void jActualizarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jActualizarMouseClicked
        ...
        try{
            ...
            con=DriverManager.getConnection("jdbc:sqlserver://localhost:1433;databaseName=PATENTES;user=sa;password=sasa;");
            Statement stmt= con.createStatement();
            ResultSet rs=stmt.executeQuery("select *from TELINV where cA4=' "+clave_c+"' AND CT1= "+clave_a+"");
            if (rs.next()) {
...
try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IAE_Telefono_Inventor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IAE_Telefono_Inventor().setVisible(true);
            }
        });
    }
